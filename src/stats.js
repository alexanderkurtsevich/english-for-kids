...
class Stats {
  ...
  createTable() {
    ...
    Object.keys(this.statsObj).forEach((key) => {
      const difficult = this.statsObj[key].errors - this.statsObj[key].correct;
    ...
    const tHeads = ['Word', 'Translation', 'Categorie', 'Train-Clicks', 'Correct', 'Errors'];
